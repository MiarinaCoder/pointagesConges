...
exports.updateParametres = async (req, res) => {
  const { tempsDebut, dureeJournee, seuilHeuresSupp, montantPenalite,heurePause } = req.body;
  try {
    await ParametresTravail.update({ tempsDebut, dureeJournee, seuilHeuresSupp, montantPenalite });
